...
@contextmanager
def username_write(session: SessionDep) -> Generator[None]:
    """The unique index is authoritative when concurrent preflight checks race."""
    try:
        yield
