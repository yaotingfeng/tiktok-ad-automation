...
import { WorkspaceTitleTarget } from "./WorkspacePageTitle"
...
export function WorkspaceShell({
  ...
  return (
    <WorkspaceTitleTarget.Provider value={titleTarget}>
      <SidebarProvider style={{ "--sidebar-width": "18rem" } as CSSProperties}>
        ...
        <SidebarInset>
          ...
          <div
            id="workspace-main"
            tabIndex={-1}
            className="flex min-w-0 flex-1 flex-col gap-6 p-4 outline-none lg:p-6"
          >
            {children}
          </div>
        </SidebarInset>
      </SidebarProvider>
    </WorkspaceTitleTarget.Provider>
  )
}
