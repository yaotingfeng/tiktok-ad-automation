...
export class ProvidersService {
    ...
    /**
     * Update Application Minis
     */
    public static updateApplicationMinis<ThrowOnError extends boolean = true>(options: Options<providersUpdateApplicationMinisData, ThrowOnError>) {
        return (options.client ?? client).patch<providersUpdateApplicationMinisResponses, providersUpdateApplicationMinisErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
