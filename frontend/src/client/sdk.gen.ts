...
export class TenantsService {
     ...
     * Post Member User
     */
    public static postMemberUser<ThrowOnError extends boolean = true>(options: Options<tenantsPostMemberUserData, ThrowOnError>) {
        return (options.client ?? client).post<tenantsPostMemberUserResponses, tenantsPostMemberUserErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class AccountsService {
     ...
     * Available Bcs
     */
    public static availableBcs<ThrowOnError extends boolean = true>(options: Options<availableBcsData, ThrowOnError>) {
        return (options.client ?? client).get<availableBcsResponses, availableBcsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Add Bindings
     */
    public static addBindings<ThrowOnError extends boolean = true>(options: Options<addBindingsData, ThrowOnError>) {
        return (options.client ?? client).post<addBindingsResponses, addBindingsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Sync Bc
     */
    public static syncMcpBc<ThrowOnError extends boolean = true>(options: Options<syncMcpBcData, ThrowOnError>) {
        return (options.client ?? client).post<syncMcpBcResponses, syncMcpBcErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Unbind Bc
     */
    public static unbindMcpBc<ThrowOnError extends boolean = true>(options: Options<unbindMcpBcData, ThrowOnError>) {
        return (options.client ?? client).delete<unbindMcpBcResponses, unbindMcpBcErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public static refreshCapabilities<ThrowOnError extends boolean = true>(options: Options<accountsRefreshCapabilitiesData, ThrowOnError>) {
        return (options.client ?? client).post<accountsRefreshCapabilitiesResponses, accountsRefreshCapabilitiesErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Capability Status
     */
    public static capabilityStatus<ThrowOnError extends boolean = true>(options: Options<accountsCapabilityStatusData, ThrowOnError>) {
        return (options.client ?? client).get<accountsCapabilityStatusResponses, accountsCapabilityStatusErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class MaterialIngestService {
    ...
    /**
     * Read Ingest Part Permissions
     */
    public static readIngestPartPermissions<ThrowOnError extends boolean = true>(options: Options<readIngestPartPermissionsData, ThrowOnError>) {
        return (options.client ?? client).get<readIngestPartPermissionsResponses, readIngestPartPermissionsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    /**
     * Acknowledge Ingest Parts
     */
    public static acknowledgeIngestParts<ThrowOnError extends boolean = true>(options: Options<acknowledgeIngestPartsData, ThrowOnError>) {
        return (options.client ?? client).post<acknowledgeIngestPartsResponses, acknowledgeIngestPartsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class MaterialsService {
     ...
     * Read Upload Batches
     */
    public static readUploadBatches<ThrowOnError extends boolean = true>(options: Options<materialsReadUploadBatchesData, ThrowOnError>) {
        return (options.client ?? client).get<materialsReadUploadBatchesResponses, materialsReadUploadBatchesErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Read Upload Request
     */
    public static readUploadRequest<ThrowOnError extends boolean = true>(options: Options<materialsReadUploadRequestData, ThrowOnError>) {
        return (options.client ?? client).get<materialsReadUploadRequestResponses, materialsReadUploadRequestErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    /**
     * Read Original Preview
     */
    public static readOriginalPreview<ThrowOnError extends boolean = true>(options: Options<materialsReadOriginalPreviewData, ThrowOnError>) {
        return (options.client ?? client).get<materialsReadOriginalPreviewResponses, materialsReadOriginalPreviewErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Read Remote Preview
     */
    public static readRemotePreview<ThrowOnError extends boolean = true>(options: Options<materialsReadRemotePreviewData, ThrowOnError>) {
        return (options.client ?? client).get<materialsReadRemotePreviewResponses, materialsReadRemotePreviewErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Authorize Reissue
     *
     * 管理员明确接受重复素材风险后，保留旧证据并单次补发指定素材；不重建未知广告。
     */
    public static authorizeReissue<ThrowOnError extends boolean = true>(options: Options<materialsAuthorizeReissueData, ThrowOnError>) {
        return (options.client ?? client).post<materialsAuthorizeReissueResponses, materialsAuthorizeReissueErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class BuildsService {
     ...
     * List Drafts
     */
    public static listDrafts<ThrowOnError extends boolean = true>(options: Options<buildsListDraftsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsListDraftsResponses, buildsListDraftsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Generate Preview
     */
    public static generatePreview<ThrowOnError extends boolean = true>(options: Options<buildsGeneratePreviewData, ThrowOnError>) {
        return (options.client ?? client).post<buildsGeneratePreviewResponses, buildsGeneratePreviewErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Preview Request
     */
    public static previewRequest<ThrowOnError extends boolean = true>(options: Options<buildsPreviewRequestData, ThrowOnError>) {
        return (options.client ?? client).get<buildsPreviewRequestResponses, buildsPreviewRequestErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Preview Summary
     */
    public static previewSummary<ThrowOnError extends boolean = true>(options: Options<buildsPreviewSummaryData, ThrowOnError>) {
        return (options.client ?? client).get<buildsPreviewSummaryResponses, buildsPreviewSummaryErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Preview Units
     */
    public static previewUnits<ThrowOnError extends boolean = true>(options: Options<buildsPreviewUnitsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsPreviewUnitsResponses, buildsPreviewUnitsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Preview Inputs
     */
    public static previewInputs<ThrowOnError extends boolean = true>(options: Options<buildsPreviewInputsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsPreviewInputsResponses, buildsPreviewInputsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Frozen Unit
     */
    public static frozenUnit<ThrowOnError extends boolean = true>(options: Options<buildsFrozenUnitData, ThrowOnError>) {
        return (options.client ?? client).get<buildsFrozenUnitResponses, buildsFrozenUnitErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Frozen Groups
     */
    public static frozenGroups<ThrowOnError extends boolean = true>(options: Options<buildsFrozenGroupsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsFrozenGroupsResponses, buildsFrozenGroupsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Skipped Materials
     */
    public static skippedMaterials<ThrowOnError extends boolean = true>(options: Options<buildsSkippedMaterialsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsSkippedMaterialsResponses, buildsSkippedMaterialsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Saved Mutation
     */
    public static savedMutation<ThrowOnError extends boolean = true>(options: Options<buildsSavedMutationData, ThrowOnError>) {
        return (options.client ?? client).get<buildsSavedMutationResponses, buildsSavedMutationErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Preview Dramas
     */
    public static previewDramas<ThrowOnError extends boolean = true>(options: Options<buildsPreviewDramasData, ThrowOnError>) {
        return (options.client ?? client).get<buildsPreviewDramasResponses, buildsPreviewDramasErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Minis Options
     */
    public static minisOptions<ThrowOnError extends boolean = true>(options: Options<buildsMinisOptionsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsMinisOptionsResponses, buildsMinisOptionsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Select Mini
     */
    public static selectMini<ThrowOnError extends boolean = true>(options: Options<buildsSelectMiniData, ThrowOnError>) {
        return (options.client ?? client).post<buildsSelectMiniResponses, buildsSelectMiniErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/api/tenants/{tenant_id}/build-drafts/{draft_id}/minis',
            ...options,
     ...
     * Put Manual Link
     */
    public static putManualLink<ThrowOnError extends boolean = true>(options: Options<buildsPutManualLinkData, ThrowOnError>) {
        return (options.client ?? client).put<buildsPutManualLinkResponses, buildsPutManualLinkErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Saved Submission
     */
    public static savedSubmission<ThrowOnError extends boolean = true>(options: Options<buildsSavedSubmissionData, ThrowOnError>) {
        return (options.client ?? client).get<buildsSavedSubmissionResponses, buildsSavedSubmissionErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Submit Preview
     */
    public static submitPreview<ThrowOnError extends boolean = true>(options: Options<buildsSubmitPreviewData, ThrowOnError>) {
        return (options.client ?? client).post<buildsSubmitPreviewResponses, buildsSubmitPreviewErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Get Submission
     */
    public static getSubmission<ThrowOnError extends boolean = true>(options: Options<buildsGetSubmissionData, ThrowOnError>) {
        return (options.client ?? client).get<buildsGetSubmissionResponses, buildsGetSubmissionErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public static getSubmissionUnits<ThrowOnError extends boolean = true>(options: Options<buildsGetSubmissionUnitsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsGetSubmissionUnitsResponses, buildsGetSubmissionUnitsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    /**
     * Get Submission Excluded
     */
    public static getSubmissionExcluded<ThrowOnError extends boolean = true>(options: Options<buildsGetSubmissionExcludedData, ThrowOnError>) {
        return (options.client ?? client).get<buildsGetSubmissionExcludedResponses, buildsGetSubmissionExcludedErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public static getSubmissionSteps<ThrowOnError extends boolean = true>(options: Options<buildsGetSubmissionStepsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsGetSubmissionStepsResponses, buildsGetSubmissionStepsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * List Submissions
     */
    public static listSubmissions<ThrowOnError extends boolean = true>(options: Options<buildsListSubmissionsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsListSubmissionsResponses, buildsListSubmissionsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public static getSubmissionGroups<ThrowOnError extends boolean = true>(options: Options<buildsGetSubmissionGroupsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsGetSubmissionGroupsResponses, buildsGetSubmissionGroupsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Get Submission Ads
     */
    public static getSubmissionAds<ThrowOnError extends boolean = true>(options: Options<buildsGetSubmissionAdsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsGetSubmissionAdsResponses, buildsGetSubmissionAdsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public static getSubmissionEvents<ThrowOnError extends boolean = true>(options: Options<buildsGetSubmissionEventsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsGetSubmissionEventsResponses, buildsGetSubmissionEventsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public static getSubmissionMaterials<ThrowOnError extends boolean = true>(options: Options<buildsGetSubmissionMaterialsData, ThrowOnError>) {
        return (options.client ?? client).get<buildsGetSubmissionMaterialsResponses, buildsGetSubmissionMaterialsErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    /**
     * Authorize Historical Read
     *
     * 管理员仅授权以同连接的新授权只读核查原对象；不会续建原提交，仍须重新准备。
     */
    public static authorizeHistoricalRead<ThrowOnError extends boolean = true>(options: Options<buildsAuthorizeHistoricalReadData, ThrowOnError>) {
        return (options.client ?? client).post<buildsAuthorizeHistoricalReadResponses, buildsAuthorizeHistoricalReadErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Get Historical Read
     *
     * 仅返回独立核查状态与对象 ID，不改变原提交。
     */
    public static getHistoricalRead<ThrowOnError extends boolean = true>(options: Options<buildsGetHistoricalReadData, ThrowOnError>) {
        return (options.client ?? client).get<buildsGetHistoricalReadResponses, buildsGetHistoricalReadErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    /**
     * Get Historical Read Request
     *
     * 按原请求 ID 只读查找核查回执；不重新选路或排队。
     */
    public static getHistoricalReadRequest<ThrowOnError extends boolean = true>(options: Options<buildsGetHistoricalReadRequestData, ThrowOnError>) {
        return (options.client ?? client).get<buildsGetHistoricalReadRequestResponses, buildsGetHistoricalReadRequestErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     * Retry Submission
     *
     * 返回永久原始 QUEUED/0 回执；分段调度进度读取 submission-recoveries。
     */
    public static retrySubmission<ThrowOnError extends boolean = true>(options: Options<buildsRetrySubmissionData, ThrowOnError>) {
        return (options.client ?? client).post<buildsRetrySubmissionResponses, buildsRetrySubmissionErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     *
     * 仅安排只读核实；返回永久原始 QUEUED/0 回执。
     */
    public static reconcileSubmission<ThrowOnError extends boolean = true>(options: Options<buildsReconcileSubmissionData, ThrowOnError>) {
        return (options.client ?? client).post<buildsReconcileSubmissionResponses, buildsReconcileSubmissionErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    /**
     * Saved Submission Recovery
     *
     * 只读原始回执：状态始终 QUEUED、scheduled_count 始终 0；不会产生或重启工作。
     */
    public static savedSubmissionRecovery<ThrowOnError extends boolean = true>(options: Options<buildsSavedSubmissionRecoveryData, ThrowOnError>) {
        return (options.client ?? client).get<buildsSavedSubmissionRecoveryResponses, buildsSavedSubmissionRecoveryErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    /**
     * Get Submission Recovery
     *
     * 只读当前分段调度进度；COMPLETED 表示扫描调度完成，不表示所有远端核实已成功。
     */
    public static getSubmissionRecovery<ThrowOnError extends boolean = true>(options: Options<buildsGetSubmissionRecoveryData, ThrowOnError>) {
        return (options.client ?? client).get<buildsGetSubmissionRecoveryResponses, buildsGetSubmissionRecoveryErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
