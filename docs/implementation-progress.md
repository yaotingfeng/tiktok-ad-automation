...
- P2.4 已提交 `2429a22`，单一迁移 head 为 `mcp_cover_evidence`。P3.6 本地提交以 `tiktok: verify dual-channel integration and pre-send evidence` 标识，覆盖整合类型检查、回归、历史迁移与发布/恢复记录；准确候选提交和后置核对登记于 [离线验收](validation/2026-09-11-tiktok-dual-channel-offline.md)。代码与测试完成本地整合，未将 23 项计划等同于全部环境验收。
