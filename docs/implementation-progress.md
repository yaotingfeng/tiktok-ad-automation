...
- [书面设计](superpowers/specs/2026-09-11-tiktok-dual-channel-mcp-design.md) 已形成，等待用户审阅后编写 P0–P3 阶段实施计划；未实施代码、数据库迁移或部署。AGENTS.md 同步登记用户变更后的通信约束，旧“仅 SDK”设计作为历史保留。
