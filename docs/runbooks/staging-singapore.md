...
- 2026-09-18 当前运行 `a6e0b67e7f9f0df3e73d540c09b8ac49506110c2`：在统一20×10滚动准备、持久成功回执和seed事件唤醒基础上，单条/批量核查共同使用整轮预算及停止栅栏，明确负详情失效旧映射，前端显示停止原因。资源准备池2，其余结果/搭建/控制各1，六服务十一进程。完整备份 `20260918T013952Z` 和独立恢复、Linux31项、配置/新前端/HTTPS验收通过。历史未知结果仍须核实，不代表整批已成功，见[验收记录](../validation/2026-09-18-material-pipeline-refactor.md)。以下版本条目为历史。
