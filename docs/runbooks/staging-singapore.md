...
- 2026-09-18 当前运行 `c0a318f2b61634cb6b1df5b4fe877077ef2f3be3`：目标URL转存及目标核验复用加密响应归档，不改变未知结果重发限制。Linux25项、023751Z五归档/1362文件/21表/1292响应独立恢复、六服务十一进程/私有配置/前端/HTTPS/双身份隔离通过；开关、额度、并发及head不变。02:38UTC原批次94/180、AD189/360，历史未知补发风险待用户选择，非整批成功，见[本轮验收](../validation/2026-09-18-target-transfer-receipts.md)。以下为历史发布。
