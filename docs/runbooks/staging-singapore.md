...
- 运行提交：`c6044077e63e7a4c117c6aea9b4c1723788fba54`；任务概览收拢与连接误报修正见[任务详情验收](../validation/2026-09-15-task-detail-refinement.md)；策略名称编辑和任务详情只读优化见[本次发布验收](../validation/2026-09-15-staging-strategy-task-ui-release.md)；20×10批量共享、MID/封面批核验、独立广告Worker与原任务补建闭环见[批处理发布验收](../validation/2026-09-15-build-batching.md)；此前封面复用、调度去重与完整备份发布见[搭建提速验收](../validation/2026-09-15-build-throughput.md)；搭建链加速、CTA 安全恢复及封面必需实测见[链路最终验收](../validation/2026-09-14-build-chain-latency.md)；素材多选弹窗发布见[批量素材验收](../validation/2026-09-14-material-batch-release.md)；MCP 刷新阻塞及原草稿恢复见[修复验收](../validation/2026-09-14-mcp-refresh-recovery.md)；最新数字剧目 ID 与已获取链接编辑见[本次发布验收](../validation/2026-09-14-drama-id-and-link-edit.md)；统一版权方选择弹窗、素材编辑和小程序选择交互见[前次发布验收](../validation/2026-09-14-build-interaction-refinement.md)；草稿箱与手动推广链接迭代见[前次发布验收](../validation/2026-09-13-staging-iteration-release.md)；自动权限与小程序名称选择见[本次验收](../validation/2026-09-13-automatic-authorization-minis.md)；同 BC 原生共享、Mini 配置入口和素材原名发布见[共享验收](../validation/2026-09-13-native-material-sharing.md)；账户解析到真实广告创建的完整验收见[广告搭建验收](../validation/2026-09-13-staging-real-ad-build.md)；完整素材响应加密留档与真实查询恢复验收见[留档发布记录](../validation/2026-09-13-material-response-archive.md)。正常成功回执直接入库、不逐条回查，见 [2026-09-13 发布记录](../validation/2026-09-13-upload-success-receipt.md)。MCP URL 素材上传及原生回执修复见 [2026-09-13 记录](../validation/2026-09-13-mcp-material-upload.md)。真实页面测试发现的接口定义修复、完整备份与当前待验项见 [端到端测试修复记录](../validation/2026-09-12-staging-e2e-schema-fix.md)。MCP 多 BC 更新及完整备份见 [多 BC 验收](../validation/2026-09-12-mcp-multiple-bcs.md)。最新 BC 分页修复及 Sun Browser 真实授权/BC 读取见 [分页验收](../validation/2026-09-12-staging-mcp-pagination.md)，此前 MCP 授权后修复见 [发布验收](../validation/2026-09-12-staging-mcp-auth-fix.md)，双通道更新、Linux 验证及客户端登记见 [首次双通道发布](../validation/2026-09-12-staging-mcp-release.md)。数据库 head 为 `build_batching`，旧版本及发布前备份保留。
