...
当前文档保存于现有资料目录的 `docs/superpowers/specs/`。实施计划采用独立应用目录 `/Users/yaotingfeng/Documents/ytf/ytf-os-ad-skill/projects/tiktok-ad-automation`；2026-09-09 已将独立应用迁入当前资料工作区，当前实施情况见 `docs/implementation-progress.md`。
